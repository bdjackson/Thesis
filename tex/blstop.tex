...
The trigger requirement is applied in both data and Monte Carlo simulation.
To account for the difference in trigger efficiency, a trigger scale factor is
applied to the Monte Carlo events which passed the trigger requirement.
