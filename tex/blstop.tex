...
For the model dependent limits, the predicted signal contamination in the CRs
is taken into account.

An expected limit is first determined for each SR

{\color{red}TODO Talk about single model test}
...
For each stop mass, exclusion fits are performed with various assumptions on
the branching ratios of the stop.

{\color{red}TODO talk about how to scale for branching fractions.}
