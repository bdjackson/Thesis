...
The electron identification efficiency is different in the data and MC
simulation.
For this reason, a \pt\ and \eta\ dependent identification scale factor is
applied to each electron in the MC simulation events, which corrects for the
observed differences in the identification efficiency.
The identification scale factors are derived 
{\color{red} TODO}
blah blah blah electron scale factors blah blah blah \cite{egamma2014}.
...
{\color{red} TODO}
blah blah blah muon scale factors blah blah blah \cite{Aad:2014rra}.
...
These trigger scale factors were provided by the \texttt{Egamma} and
\texttt{Muon} performance groups using the \texttt{TrigMuonEfficency} package.
