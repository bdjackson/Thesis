...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.6\textwidth]{figs/regions__met_sig__ht_plane.pdf}
...
\resizebox{0.48\linewidth}{!}{
  ...
  \node[anchor=south west, inner sep=0] (image) at (0,0) {
    \includegraphics[width=0.48\textwidth]{figs/ht_sr_400_minus_ht.pdf}
  };
  \end{tikzpicture}
}
%%
\resizebox{0.48\linewidth}{!}{
  \begin{tikzpicture}
  \node[anchor=south west, inner sep=0] (image) at (0,0) {
    \includegraphics[width=0.48\textwidth]{figs/mbl_asym_sr_400_minus_mbl_asym.pdf}
  };
  \end{tikzpicture}
}
%%
\resizebox{0.48\linewidth}{!}{
  \begin{tikzpicture}
  \node[anchor=south west, inner sep=0] (image) at (0,0) {
    \includegraphics[width=0.48\textwidth]{figs/mbl_0_sr_minus_mbl.pdf}
  };
  \end{tikzpicture}
}
...
\begin{figure}[ht]
\centering
\includegraphics[width=\textwidth]{figs/histpull_VR_detailed.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.48\textwidth]{figs/vr_top_3_mbl_0.pdf}
  \includegraphics[width=0.48\textwidth]{figs/vr_Z_mbl_0.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.48\textwidth]{figs/vr_top_3_ht_signal.pdf}
  \includegraphics[width=0.48\textwidth]{figs/vr_Z_ht_signal.pdf}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.45\textwidth]{figs/sr_mbl_0.pdf}
  \includegraphics[width=0.45\textwidth]{figs/sr_ht.pdf}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{figs/limit_contours.pdf}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.6\textwidth]{figs/mass_limit_contours_no_extras_obs.pdf}
