...
identifying 2, 1, 0 correct pairs in simulated stop events is shown in
Figure~\ref{fig:pairing_eff}.
...
The scenario where one pair is identified correctly corresponds to events where
one pair is grouped correctly, but at least of of the $b$-tagged jets or one of
the leptons is not matched to a stop parent.
...
%% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
The uncertainty on the JES has an impact on both the jet
selection criteria and the derived kinematic variabless of the event, such as
...
uncertainty on the event yield.
...
For this reason, the uncertainty on the $Wt$-channel cross section is the only
