...
high quality tracks.
These include at least one hit on track in both the B layer and the Pixel
detector.
The ID track must also have at least 5 hits in the SCT, at most 2 holes
in both the Pixel detector and the SCT. 
...
This means $\MBL^{0} \geq \MBL^{1}$ by definition.
...
depending on the mass of the simulated stop. This pairing efficiency, shown in
...
\begin{figure}[ht]
  ...
  \caption{The efficiency of correctly pairing $b$-tagged jets and leptons
    ...
    where one of the $b$-tagged jets or the leptons were not matched to the
    stop, but the other pair was grouped correctly.
