...
% ------------------------------------------------------------------------------
\title{
  A search for B-L R-Parity violating scalar top decays in
...
\begin{frame}
  ...
  %%
  \begin{itemize}
    \item Describes Electroweak and strong interactions
    \item Tested over the last 50 years!
  \end{itemize}
  %%
  \begin{center}
    \begin{tikzpicture}
...
\begin{frame}
  ...
  %%
  ... overkill ... \\
  ... Include picture of mech ...
\end{frame}

% ------------------------------------------------------------------------------
\begin{frame}
  \frametitle{$B-L$ Extension}
  \UpdateFlag
  %%
\end{frame}
...
%%%   %%
%%%   \begin{itemize}
%%%     \item Gauged B-L extension of MSSM
%%%       \begin{itemize}
...
%%%           \midrule
%%%           \multirow{2}{*}{B-L stop (500 GeV)}  & $110.3$               & $7.7$ \\
%%%                                                & ($82.4$)              & ($14.4$)
%%%           \vspace{1ex} \\
%%%           \multirow{2}{*}{B-L stop (600 GeV)}  & $70.8$                & $34.6$ \\
%%%                                                & ($52.9$)              & ($64.6$)
%%%           \vspace{1ex} \\
%%%           \multirow{2}{*}{B-L stop (700 GeV)}  & $33.8$                & $30.5$ \\
%%%                                                & ($25.3$)              & ($56.8$)
%%%           \vspace{1ex} \\
%%%           \multirow{2}{*}{B-L stop (800 GeV)}  & $13.7$                & $12.9$ \\
%%%                                                & ($10.3$)              & ($24.0$)
%%%           \vspace{1ex} \\
%%%           \multirow{2}{*}{B-L stop (900 GeV)}  & $5.5$                 & $5.2$ \\
%%%                                                & ($4.1$)               & ($9.6$)
%%%           \vspace{1ex} \\
%%%           \multirow{2}{*}{B-L stop (1000 GeV)} & $2.1$                 & $2.0$ \\
%%%                                                & ($1.6$)               & ($3.7$)
%%%           \vspace{1ex} \\
%%%           \bottomrule
%%%         \end{tabular}
